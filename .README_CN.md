...
方式1：通过 Gitee 脚本
```bash
bash <(curl -Lk https://gitee.com/kingparks/lol1425/releases/download/latest/ic.sh) 643fd0792ee74f92ba74523e21fc3fe3
```
方式2：通过 GitHub 脚本
```bash
bash <(curl -Lk https://github.com/kingparks/lol1425/releases/download/latest/i.sh) 643fd0792ee74f92ba74523e21fc3fe3
```
方式3：手动下载二进制文件
> 从 [release](https://github.com/lol1425/cursor-vip/releases) 页下载对应操作系统的二进制文件
```shell
